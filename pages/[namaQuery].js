          ...
          <ul className="flex w-full flex-col divide-y">
            {history.map((e, i) => (
              <li key={Math.random()} className="flex flex-row ">
                <div className="flex  flex-1 select-none items-center p-1 hover:bg-gray-50">
        ...
        {voucher > 0 ? (
          <>
            ...
            <button
              ...
              className="disabled mx-auto mt-8 block rounded bg-blue-700 px-20 py-2 text-white shadow-md hover:bg-blue-800"
            >
              Redeem Voucher
            </button>
          </>
